...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // login() handles redirect to / — don't push here
    } catch (err: unknown) {
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-page {
          min-height: 100vh;
          background: linear-gradient(160deg, #dbeafe 0%, #e0f2fe 55%, #f0f9ff 100%);
          display: flex;
        ...
        .auth-left {
          ...
          position: relative;
          overflow: hidden;
          border-right: 1px solid rgba(14,99,214,0.15);
        }
        .auth-left-grid {
          position: absolute; inset: 0;
          background-image:
            linear-gradient(rgba(14,99,214,0.07) 1px, transparent 1px),
            linear-gradient(90deg, rgba(14,99,214,0.07) 1px, transparent 1px);
        ...
        .data-line {
          ...
          height: 1px; background: rgba(13,110,253,0.1);
        ...
        .data-dot {
          ...
          background: #1d6fd8;
          animation: dataTrav 2.4s linear infinite;
        }
        ...
        .arc {
          ...
          border-right-color: rgba(13,110,253,0.45);
          border-top-color: rgba(13,110,253,0.45);
          border-radius: 50%;
          animation: arcPulse 1.8s ease-in-out infinite;
        }
        .arc-1 { width: 14px; height: 14px; animation-delay: 0s; }
        ...
        .auth-left-title {
          ...
          color: var(--text-head); letter-spacing: -0.5px;
        ...
        .auth-left-sub {
          ...
          letter-spacing: 1.5px; text-align: center; margin-bottom: 22px;
          position: relative; z-index: 1;
        }
        .chip-stats {
        ...
        .auth-scanbar {
          ...
          animation: scanbar 3s ease-in-out infinite; opacity: 0.4;
        }
        @keyframes scanbar {
        ...
        .auth-eyebrow {
          font-size: 8px; letter-spacing: 3px; color: var(--blue-mid);
        ...
        .auth-heading {
          ...
          color: var(--text-head); letter-spacing: -0.3px; margin-bottom: 2px;
        }
        .auth-sub { font-size: 10px; color: var(--text-muted); letter-spacing: 0.5px; margin-bottom: 22px; }
        ...
        .auth-input {
          ...
          font-family: var(--mono); font-size: 11px; color: var(--text-head);
          outline: none;
        ...
        .auth-divider { border: none; border-top: 1px solid rgba(13,110,253,0.12); margin: 18px 0; }
          ...
          <div className="auth-card">
            ...
            <div className="auth-right">
              ...
              <div className="auth-eyebrow">
                <span className="eyebrow-line" /> ACCESS PORTAL
              </div>
              <h1 className="auth-heading">Welcome back</h1>
              <p className="auth-sub">Sign in to your YH account</p>
